...
const MyProfile = () => {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white-1 text-black-1 dark:text-white-1 shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-white-1 hover:bg-opacity-80 xsm:px-4"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white-1/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={user?.photoURL} alt="profile" className='h-30 w-full max-w-30 rounded-full'/>
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white-1 hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          <div className="mt-4">
            ...
            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium ">
                Follow me on
              </h4>
                  ...
                  >
                    ...
                    <defs>
                      <clipPath id="clip0_30_966">
                        <rect width="22" height="22" fill="white-1" />
                      </clipPath>
                    </defs>
                  </svg>
                </a>
