		...
		<div>
			<div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
				<div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
					<div>
						<p className="inline-block px-3 py-px mb-4 text-lg font-semibold tracking-wider text-cyan-800 uppercase rounded-full bg-teal-accent-400">
							Tourist Guide
						</p>
					</div>
					<h2 className="max-w-lg mb-6 text-3xl font-bold leading-none tracking-tight dark:text-cyan-300 sm:text-2xl md:mx-auto">
				...
				<div className="flex flex-col sm:grid gap-10 items-center row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
					<div className="flex">
						<img
